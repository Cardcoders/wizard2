...
// var game = new Phaser.Game(850, 850, Phaser.AUTO, 'phaser-example', { preload: preload, create: create, render: render });

// function preload() {

//     game.load.image('ilkke', 'assets/wizardlmao.png');
...
// }
// game.state.add('test', game_state.test);
